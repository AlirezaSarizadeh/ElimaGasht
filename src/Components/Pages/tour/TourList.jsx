...
const TourList = () => {
  ...
  const handleBuyTicket = () => {
    navigate(
      `/ticket?date2=${date2}$date=${date}&way1=${way1}&way2=${way2}&passenger=${passenger}`
    );
  };
  return (
    <motion.div
    ...
    >
      <div className="h w flex flex-col justify-start overflow-y-hidden items-center gap-[20px] bg-[url('/public/image/flight-pattern.png')] bg-right bg-no-repeat   ">
        ...
        <div className="w-[85%] h-[80px] border border-gray-400 flex justify-around items-center rounded-2xl mt-[50px]">
          ...
          <div className="f gap-[20px] text-[25px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        <div className="w-[90%]  h-[3000px]  pb-[20px] gap-[20px] f">
          ...
          <div className="w-[70%]   h overflow-scroll scrollbar-hide flex flex-col justify-start  items-center  ">
            <div className="f w flex-col gap-[20px] ">
              {Array.from({ length: 15 }).map((_, index) => (
                <div
                  key={index}
                  className="w h-[250px] flex flex-col justify-center items-center rounded-xl border bg-white/70 border-gray-400"
                >
                  <div className="w h-[30%] f px-[20px]">
                    <div className=" w h flex justify-around gap-[20px] items-center">
                      <button className=" px-3 py-1 bg-red-100 rounded-xl hover:bg-red-200 t text-red-700">
                        مشاهده اطلاعات
                      </button>
                      <button className=" px-3 py-1 bg-red-100 rounded-xl hover:bg-red-200 t text-red-700">
                        مشاهده قوانین
                  ...
                  <div className="w h-[70%] f">
                    <div className="w h f gap-[20px] pr-[20px]">
                      ...
                      <div className="f flex-col">
                        <h1 className="font-semibold text-[20px]">02:50</h1>
                        <span className="text-gray-500">استانبول (SAW) </span>
                      </div>
                      <div className="f flex-col h w-[200px] ">
                        <div className="w h border-b f relative border-gray-400  border-dashed">
                          <div className="f gap-[5px] text-[15px] text-gray-500">
                            ...
                            >
                              <path d="M8.00008 15.6667C4.50675 15.6667 1.66675 12.8267 1.66675 9.33333C1.66675 5.84 4.50675 3 8.00008 3C11.4934 3 14.3334 5.84 14.3334 9.33333C14.3334 12.8267 11.4934 15.6667 8.00008 15.6667ZM8.00008 4C5.06008 4 2.66675 6.39333 2.66675 9.33333C2.66675 12.2733 5.06008 14.6667 8.00008 14.6667C10.9401 14.6667 13.3334 12.2733 13.3334 9.33333C13.3334 6.39333 10.9401 4 8.00008 4Z" />
                              <path d="M8 9.66668C7.72667 9.66668 7.5 9.44001 7.5 9.16668V5.83334C7.5 5.56001 7.72667 5.33334 8 5.33334C8.27333 5.33334 8.5 5.56001 8.5 5.83334V9.16668C8.5 9.44001 8.27333 9.66668 8 9.66668Z" />
                              <path d="M10 2.33333H6C5.72667 2.33333 5.5 2.10666 5.5 1.83333C5.5 1.55999 5.72667 1.33333 6 1.33333H10C10.2733 1.33333 10.5 1.55999 10.5 1.83333C10.5 2.10666 10.2733 2.33333 10 2.33333Z" />
                            </svg>
                            19:00
                          </div>
                          <img
                            src="/public/image/flight-icon.png"
                            alt=""
                            className="w-[30px] absolute -bottom-1 scale-x-[-1]"
                          />
                        </div>
                        <div className="w h f text-gray-500 text-[15px]">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="17"
                            ...
                            className="fill-gray-500"
                          >
                            <path d="M11 6.25334C10.7267 6.25334 10.5 6.02667 10.5 5.75334V4.83334C10.5 4.13334 10.2 3.45334 9.68 2.98001C9.15333 2.50001 8.47333 2.28001 7.75333 2.34667C6.55333 2.46001 5.5 3.68667 5.5 4.96667V5.61334C5.5 5.88667 5.27333 6.11334 5 6.11334C4.72667 6.11334 4.5 5.88667 4.5 5.61334V4.96001C4.5 3.16667 5.94667 1.51334 7.66 1.34667C8.66 1.25334 9.62 1.56667 10.3533 2.24001C11.08 2.90001 11.5 3.84667 11.5 4.83334V5.75334C11.5 6.02667 11.2733 6.25334 11 6.25334Z" />
                            <path d="M9.99988 15.6667H5.99988C2.91988 15.6667 2.34655 14.2333 2.19988 12.84L1.69988 8.84668C1.62655 8.12668 1.59988 7.09334 2.29988 6.32001C2.89988 5.65334 3.89321 5.33334 5.33321 5.33334H10.6665C12.1132 5.33334 13.1065 5.66001 13.6999 6.32001C14.3932 7.09334 14.3732 8.12668 14.2999 8.83334L13.7999 12.84C13.6532 14.2333 13.0799 15.6667 9.99988 15.6667ZM5.33321 6.33334C4.20655 6.33334 3.43321 6.55334 3.03988 6.99334C2.71321 7.35334 2.60655 7.90668 2.69321 8.73334L3.19321 12.7267C3.30655 13.7933 3.59988 14.6733 5.99988 14.6733H9.99988C12.3999 14.6733 12.6932 13.8 12.8065 12.74L13.3065 8.73334C13.3932 7.92001 13.2865 7.36668 12.9599 7.00001C12.5665 6.55334 11.7932 6.33334 10.6665 6.33334H5.33321Z" />
                            <path d="M10.28 9.26665C9.90669 9.26665 9.60669 8.96665 9.60669 8.59999C9.60669 8.23332 9.90669 7.93332 10.2734 7.93332C10.64 7.93332 10.94 8.23332 10.94 8.59999C10.94 8.96665 10.6467 9.26665 10.28 9.26665Z" />
                            <path d="M5.61327 9.26665C5.23994 9.26665 4.93994 8.96665 4.93994 8.59999C4.93994 8.23332 5.23994 7.93332 5.60661 7.93332C5.97327 7.93332 6.27327 8.23332 6.27327 8.59999C6.27327 8.96665 5.97994 9.26665 5.61327 9.26665Z" />
                          </svg>
                          kg 20
                        </div>
                      </div>
                      <div className="f flex-col">
                        <h1 className="font-semibold text-[20px]">21:50</h1>
                        <span className="text-gray-500">دبی (DXB)</span>
                      </div>
                    </div>
                    <div className="w h p-[20px] flex justify-end items-end ">
                      <div className="f text-sky-400 gap-[20px]">
                        ...
                        <button
                          ...
                          className="w-[200px] h-[40px] bg-[#F0421A] rounded-xl text-white"
                        >
                          جزئیات بلیط
                        </button>
                      </div>
